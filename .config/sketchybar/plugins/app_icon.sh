...
case "$1" in
"Terminal" | "Warp" | "iTerm2" | "Alacritty" | "kitty")
  RESULT=$ICON_TERM
...
"Photo Booth")
  RESULT=$ICON_CAMERA
  ;;
"Safari" | "Beam" | "DuckDuckGo" | "Arc" | "Microsoft Edge" | "Google Chrome" | "Firefox" | "Zen" | "Zen Browser")
  RESULT=$ICON_WEB
  ;;
...
"NordVPN")
  RESULT=$ICON_VPN
  ;;
"Progressive Downloader" | "Transmission")
